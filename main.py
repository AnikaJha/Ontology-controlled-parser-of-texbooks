...
rawText = 'Мотоцикл за первые два часа проехал 90 км, а следующие 3 часа двигался со скоростью 50 км/ч. ' \
          'Какой была скорость мотоциклиста на первом участке пути? Какой путь он прошел за все время движения? '
